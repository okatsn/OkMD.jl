...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://okatsn.github.io/OkMD.jl/stable/)
[![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://okatsn.github.io/OkMD.jl/dev/)
[![Build Status](https://github.com/okatsn/OkMD.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/okatsn/OkMD.jl/actions/workflows/CI.yml?query=branch%3Amain)
[![Coverage](https://codecov.io/gh/okatsn/OkMD.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/okatsn/OkMD.jl)
...
!!! note Checklist
    - [x] Create an empty repository (namely, `https://github.com/okatsn/OkMD.jl.git`) on github, and push the local to origin. See [connecting to remote](#tips-for-connecting-to-remote).
...
### Auto-Registration
- You have to add `ACCESS_OKREGISTRY` to the secret under the remote repo (e.g., https://github.com/okatsn/OkMD.jl).
...
Connect to remote:
1. Switch to the local directory of this project (OkMD)
2. Add an empty repo OkMD(.jl) on github (without anything!)
...
This package is create on 2023-02-10.
